...
**Identity linking at sign-in (per [PRD-2](/prds/prd-2-player-signup.md) §3.1):**
...
- Magic-link always uses tenant-level SMTP (per [PRD-0](/prds/prd-0-overview.md) §3.4).

See [PRD-2](/prds/prd-2-player-signup.md) §3.1 for the full account-creation flow with diagrams and [PRD-2](/prds/prd-2-player-signup.md) §5d.1 for the account-page IDENTITIES section where users manage their linked providers.
...
- [PRD-7](/prds/prd-7-testing-strategy.md)
