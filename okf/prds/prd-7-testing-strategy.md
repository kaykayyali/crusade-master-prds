...
- Routing decisions ([PRD-5](/prds/prd-5-approval-system.md) §3.2 routing logic in isolation)
...
### 5.3 RLS verification (critical — [PRD-0](/prds/prd-0-overview.md) §4b)
...
Beyond RLS, verify:
- Same email can have User rows in two tenants ([PRD-2](/prds/prd-2-player-signup.md) §3.1 design)
...
- **Critical user flows** — the 6 page surfaces ([PRD-2](/prds/prd-2-player-signup.md) §5c, §5d):
...
### 13.1 "Player Sarah's journey" ([PRD-2](/prds/prd-2-player-signup.md) + [PRD-3](/prds/prd-3-army-export-versioning.md) + [PRD-5](/prds/prd-5-approval-system.md))

1. Sarah signs in via Discord OAuth ([PRD-2](/prds/prd-2-player-signup.md))
2. Sarah accepts invite to Aurelian campaign, joins Helsreach Defenders, picks Astra Militarum ([PRD-2](/prds/prd-2-player-signup.md))
3. Sarah uploads her first roster ([PRD-3](/prds/prd-3-army-export-versioning.md))
4. Pipeline parses, diffs vs. nothing (first time), runs rule checks ([PRD-3](/prds/prd-3-army-export-versioning.md))
5. Sarah submits for approval ([PRD-5](/prds/prd-5-approval-system.md))
6. Mike (TL of Helsreach Defenders) sees in inbox, approves ([PRD-5](/prds/prd-5-approval-system.md))
7. Sarah sees RosterApproved in her roster view ([PRD-3](/prds/prd-3-army-export-versioning.md))
8. Sarah files a battle update ([PRD-4](/prds/prd-4-events-deltas.md) §7b.1)
9. Mike approves; battle update becomes part of history ([PRD-5](/prds/prd-5-approval-system.md))
10. Sarah views her Timeline ([PRD-4](/prds/prd-4-events-deltas.md) §7)

### 13.2 "CM Mike runs the campaign" ([PRD-1](/prds/prd-1-crusade-master-admin.md) + [PRD-3](/prds/prd-3-army-export-versioning.md) + [PRD-5](/prds/prd-5-approval-system.md))

1. Mike creates Aurelian campaign via 6-step wizard ([PRD-1](/prds/prd-1-crusade-master-admin.md) §4.1)
2. Mike creates 4 teams, sets expected factions ([PRD-1](/prds/prd-1-crusade-master-admin.md) §5b)
3. Mike invites players; they accept ([PRD-2](/prds/prd-2-player-signup.md))
4. Mike promotes Sarah to TL of Helsreach Defenders ([PRD-1](/prds/prd-1-crusade-master-admin.md) §4.2)
5. Mike starts the campaign (gate: every team has ≥1 TL) ([PRD-1](/prds/prd-1-crusade-master-admin.md) §4.1)
6. Mike configures rules per [PRD-1](/prds/prd-1-crusade-master-admin.md) §4.4 ([PRD-3](/prds/prd-3-army-export-versioning.md) §6)
7. Mike sees campaign inbox, approves various requests ([PRD-5](/prds/prd-5-approval-system.md))
8. Mike changes a rule mid-campaign; system shows warning ([PRD-1](/prds/prd-1-crusade-master-admin.md) §4.4, v3.17)
9. Mike ends campaign; everyone can read across teams ([PRD-1](/prds/prd-1-crusade-master-admin.md) §4.1, post-crusade relaxation)

### 13.3 "Auto-approve + pipeline runs" ([PRD-1](/prds/prd-1-crusade-master-admin.md) + [PRD-5](/prds/prd-5-approval-system.md))

1. Mike is also a player on Helsreach Defenders ([PRD-1](/prds/prd-1-crusade-master-admin.md) §5)
2. Mike files a battle update as a player
3. ApprovalRequest is created (not skipped); approvalSource = 'self_approved'
4. Rule checks run ([PRD-5](/prds/prd-5-approval-system.md) §3.3)
...
### 13.4 "RLS prevents cross-tenant access" ([PRD-0](/prds/prd-0-overview.md))
...
- **[PRD-0](/prds/prd-0-overview.md)**: data model, tenancy, RLS policies
- **[PRD-1](/prds/prd-1-crusade-master-admin.md)**: campaign lifecycle, CM-as-player
- **[PRD-2](/prds/prd-2-player-signup.md)**: auth, OAuth, magic-link
- **[PRD-3](/prds/prd-3-army-export-versioning.md)**: roster pipeline
- **[PRD-4](/prds/prd-4-events-deltas.md)**: events, history
- **[PRD-5](/prds/prd-5-approval-system.md)**: approval routing
...
- [PRD-6](/prds/prd-6-technical-architecture.md)
