...
- **[PRD-0](/prds/prd-0-overview.md)**: data model defines response shapes
- **[PRD-1](/prds/prd-1-crusade-master-admin.md)**: CM admin endpoints
- **[PRD-2](/prds/prd-2-player-signup.md)**: auth endpoints (OAuth, magic-link)
- **[PRD-3](/prds/prd-3-army-export-versioning.md)**: roster endpoints
- **[PRD-4](/prds/prd-4-events-deltas.md)**: event endpoints, history endpoints
- **[PRD-5](/prds/prd-5-approval-system.md)**: approval endpoints
